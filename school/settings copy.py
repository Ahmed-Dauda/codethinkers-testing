...
# git commit --allow-empty -m "switch to stable"
# git push origin restore-working-version:main --force

# Switch to new version (any other branch):
# git commit --allow-empty -m "switch to new version"
# git push origin your-branch-name:main --force


# To switch back to main:
# git checkout main
# git commit --allow-empty -m "switch to main"
# git push origin main --force

# ssh root@204.168.237.20
# MyServer2026!Coolify
# cd /var/www/codethinkers
# token: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
