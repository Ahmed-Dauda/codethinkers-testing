...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'student_portal' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_PATH', 'C:/Users/HP/Desktop/DESKTOP FOLDERS/DJANGO_PROJECTS/codethinkers-testing/project_databases/project_143.sqlite3'),
        'OPTIONS': {
