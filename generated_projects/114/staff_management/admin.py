...
class StaffAdmin(ExportAdminMixin, admin.ModelAdmin):
...
class PerformanceReviewAdmin(ExportAdminMixin, admin.ModelAdmin):
    list_display = ('staff', 'review_date', 'score')
    list_filter = ('staff', 'review_date')
    search_fields = ('staff__name',)
    list_per_page = 25
    readonly_fields = ('created_at', 'updated_at')
    list_select_related = ('staff',)
