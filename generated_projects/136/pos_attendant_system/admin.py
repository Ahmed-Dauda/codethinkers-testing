...
@admin.register(PosAttendant)
class PosAttendantAdmin(ExportAdminMixin, admin.ModelAdmin):
    list_display = ('name',)
    search_fields = ('name',)
    list_per_page = 25
...
class SalesRecordAdmin(ExportAdminMixin, admin.ModelAdmin):
    list_display = ('attendant', 'date', 'total_sales')
    list_filter = ('attendant', 'date')
    search_fields = ('attendant__name',)
    list_per_page = 25
    list_select_related = ('attendant',)
    readonly_fields = ('created_at', 'updated_at')