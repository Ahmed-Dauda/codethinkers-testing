...
@admin.register(Quiz)
class QuizAdmin(ExportAdminMixin, admin.ModelAdmin):
...
class AnswerAdmin(ExportAdminMixin, admin.ModelAdmin):
    list_display = ('question', 'selected_option', 'created_at')
...
class StudentScoreAdmin(ExportAdminMixin, admin.ModelAdmin):
    list_display = ('quiz', 'score', 'created_at')
    list_filter = ('quiz',)
