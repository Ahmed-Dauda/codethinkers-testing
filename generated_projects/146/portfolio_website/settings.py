...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'portfolio_website' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_PATH', 'C:/Users/HP/Desktop/DESKTOP FOLDERS/DJANGO_PROJECTS/codethinkers-testing/project_databases/project_146.sqlite3'),
        'OPTIONS': {
